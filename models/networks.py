...
import numpy as np
from .basicvsr_arch import BasicVSRNet
import wandb
...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal',
    ...
    if netG == 'resnet_9blocks':
        ...
        spynet_pretrained = Path(__file__).resolve().parent.parent / 'checkpoints' / 'spynet' / 'spynet_sintel_final-3d2a1287.pth'

        net = BasicVSRNet(mid_channels=128, num_blocks=20, spynet_pretrained=spynet_pretrained)
    ...
    def forward(self, feats, num_patches=64, patch_ids=None):
        ...
        for feat_id, feat in enumerate(feats):
            ...
            if num_patches > 0:
                ...
                patch_id = torch.tensor(patch_id, dtype=torch.long, device=feat.device) # <---- Extra modification in the main project for multiplt gpus
